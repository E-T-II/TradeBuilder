...
function StepRail({
  ...
  return (
    <nav aria-label="Steps" className="space-y-1">
      {STEPS.map((s, i) => {
        const done = i < step;
        ...
        return (
          ...
          >
            ...
            <span>
              <span
                className={`block text-sm ${current ? "font-medium" : ""}`}
              >
                {s.title}
              </span>
    ...
    <Card className="overflow-hidden p-0">
      <div className="lg:grid lg:grid-cols-[250px_minmax(0,1fr)]">
        <aside className="hidden border-r bg-muted/20 p-5 lg:block">
          <StepRail step={step} reachable={reachable} onJump={onJump} />
        </aside>

        <div className="flex min-h-[70svh] flex-col p-6 lg:min-h-[540px] lg:p-8">
              ...
              <>
                ...
                >
                  <Input
                    ...
                    onChange={(e) =>
                      onChange({ accountBalance: e.target.value })
                    }
                  />
                </Field>
          ...
          <div className="mt-8 flex items-center justify-between gap-3">
            ...
            <Button onClick={onNext} disabled={remaining > 0} size="lg">
              {remaining > 0
